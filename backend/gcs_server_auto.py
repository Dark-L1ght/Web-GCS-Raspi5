...
def stop_mission_and_land():
    ...
    # Command to find the process ID of auto_mode_start.py and kill it
    kill_command = "pgrep -f auto_mode_start.py | xargs kill -9"
    ...
    while True:
        ...
        if msg:
            ...
            if msg_type == 'STATUSTEXT':
                ...
                data = {'pitch': msg.pitch * 180.0 / 3.14, 'roll': msg.roll * 180.0 / 3.14,
                        'yaw': msg.yaw * 180.0 / 3.14}
                vehicle_state.update(data)

            elif msg_type == 'GLOBAL_POSITION_INT':
                data = {'lat': msg.lat / 1e7, 'lon': msg.lon / 1e7, 'alt_msl': msg.alt / 1000.0,
                        'alt_rel': msg.relative_alt / 1000.0, 'heading': msg.hdg / 100.0}
                vehicle_state.update(data)

            elif msg_type == 'VFR_HUD':
                data = {'airspeed': msg.airspeed, 'groundspeed': msg.groundspeed, 'throttle': msg.throttle,
                        'climb': msg.climb}
                vehicle_state.update(data)

            elif msg_type == 'SYS_STATUS':
                data = {'voltage': msg.voltage_battery / 1000.0, 'current': msg.current_battery / 100.0,
