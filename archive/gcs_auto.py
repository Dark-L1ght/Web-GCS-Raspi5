...
def stop_mission_and_land():
    ...
    # Command to find the process ID of auto_start.py and kill it
    kill_command = "pgrep -f auto_start.py | xargs kill -9"
        ...
        async for message in websocket:
            try:
                ...
                if action == "start_mission":
                    ...
                    script_path = "/home/kingphoenix/Web-GCS-Raspi5/scripts/run_auto.sh"
